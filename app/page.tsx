          ...
          <section className="w-full max-w-3xl mx-auto flex flex-col items-center text-center gap-8 py-16">
            ...
            <div className="relative flex flex-col items-center gap-4 animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl">
                Where developers <span className="font-semibold text-primary">showcase</span> their work, <span className="font-semibold text-primary">connect</span> with others, and <span className="font-semibold text-primary">build</span> the future together.
              </p>
              <div className="flex flex-wrap gap-4 justify-center mt-4">
                <Link href="/portfolios"><Button size="lg" className="group transition-all duration-200">
                  Get Started
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .animate-pulse-slower { animation: pulse 12s cubic-bezier(.4,0,.6,1) infinite; }
      `}</style>
    </>
  )
}