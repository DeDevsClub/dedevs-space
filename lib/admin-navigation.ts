  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/admin/dashboard/projects/custom",
        icon: Code,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        id: "media-library",
        title: "Media Library",
        href: "/admin/dashboard/content/media",
        icon: Database,
    ...
    children: [
      {
        ...
        title: "Page Design",
        href: "/admin/dashboard/customize",
        icon: Palette,
      ...
      },
      {
        ...
        href: "/admin/dashboard/customize/theme",
        icon: Settings,
    ...
    children: [
      {
        id: "profile-views",
        title: "Profile Views",
        href: "/admin/dashboard/analytics/views",
        icon: BarChart3,
      ...
      },
      {
        ...
        href: "/admin/dashboard/analytics/contacts",
        icon: Mail,
        badge: 3,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/admin/dashboard/settings/privacy",
        icon: Shield,
    ...
    children: [
      {
        id: "documentation",
        title: "Documentation",
        href: "/admin/dashboard/help/docs",
        icon: FileText,
      ...
      },
      {
        ...
        href: "/admin/dashboard/help/support",
        icon: Mail,
