  ...
  const quickActions: QuickAction[] = useMemo(
    () => [
      // Create Actions
      {
        ...
        icon: Zap,
        action: () => router.push("/admin/dashboard/skills"),
        category: "Create",
      ...
      },
      {
        ...
        icon: User,
        action: () => router.push("/admin/dashboard/experience"),
        category: "Create",
      ...
      },
      {
        ...
        icon: FileText,
        action: () => router.push("/admin/dashboard/content/articles"),
        category: "Create",
      ...
      },
      {
        ...
        icon: Youtube,
        action: () => router.push("/admin/dashboard/content/youtube"),
        category: "Create",
      ...
      },
      {
        ...
        icon: Code,
        action: () => router.push("/admin/dashboard/projects"),
        category: "Create",
      ...
      // Quick Navigation
      {
        ...
        icon: Rocket,
        action: () => window.open("/alex-dev", "_blank"),
        category: "Navigate",
      ...
      },
      {
        ...
        icon: Palette,
        action: () => router.push("/admin/dashboard/customize"),
        category: "Navigate",
      ...
      },
      {
        ...
        icon: BarChart3,
        action: () => router.push("/admin/dashboard/analytics/views"),
        category: "Navigate",
